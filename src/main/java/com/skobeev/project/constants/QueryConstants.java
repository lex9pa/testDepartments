...
//    public static final String GET_EMPLOYEE_LIST_BY_DEP_ID = "select * FROM employee WHERE department_id = ?";
    ...
    public static final String SELECT_EMPLOYEE_MAIL = "select * FROM employee where employee_email=?";
    ...
    public static final String SELECT_DEPARTMENT_BY_NAME = "select * FROM department where department_name=?";
}
